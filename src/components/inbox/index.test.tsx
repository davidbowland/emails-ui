...
describe('Inbox component', () => {
  beforeAll(() => {
    ...
    mocked(emails).getAllReceivedEmails.mockResolvedValue(emailBatch)
    mocked(emails).getReceivedEmailContents.mockResolvedValue(emailContents)
  })
  ...
  test('expect error message when getAllReceivedEmails rejects', async () => {
    mocked(emails).getAllReceivedEmails.mockRejectedValueOnce(undefined)
    render(<Inbox />)
  ...
  test('expect message when no emails', async () => {
    mocked(emails).getAllReceivedEmails.mockResolvedValueOnce([])
    render(<Inbox />)
  ...
  test('expect error message when getReceivedEmailContents rejects', async () => {
    mocked(emails).getReceivedEmailContents.mockRejectedValueOnce(undefined)
    render(<Inbox />)
